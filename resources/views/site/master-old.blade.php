...
lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('siteassets/css/style (2).css') }}" />
          ...
          <nav class="navbar navbar-expand-xl"id="navbar" >
            ...
            <form action="{{ route('site.search') }}" method="GET">
              <div class="search-wrapper">
                <input placeholder="{{ __('site.Search') }}" class="form-control" type="search" name="s" value="{{request()->s }}">
                ...
                <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                  ...
                  <div class="collapse navbar-collapse me-auto justify-content-center mx-3" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link {{ Request::routeIs('site.contact') ? 'active' : '' }}" href="{{ route('site.booking') }}">{{ __('site.Contact us') }}</a>
                      </li>
                ...
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a class="nav-link" href="#">
                      <img src="{{ asset('siteassets/images/Group 138.svg') }}" alt=""></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">
                      <img src="{{ asset('siteassets/images/Group 139.svg') }}" alt=""></a>
                  </li>
                    <!-- Languages -->
                <li class="dropdown-item">
                    <select class="form-control" onchange="window.location.href =this.value">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <option class="" {{ app()->currentLocale() == $localeCode ? 'selected' : '' }}
