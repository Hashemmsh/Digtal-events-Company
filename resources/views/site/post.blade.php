@extends('site.master')
@section('title' , 'Post-'. config('app.name'))
@section('content')
@php
    use App\Models\Post;
                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center mb-5">
                      <div class="col-md-5" data-aos="fade-left">
                        <a href="#"><img src="{{ asset('uploads/post/'.$post->image) }}" alt="#" /></a>
                      </div>
                      <div class="col-md-7" data-aos="fade-right">
                        <h3> <a href="">{{ $post->trans_name }}</a> </h3>
                        <p class="mt-3">
                            {!! $post->trans_description !!}
                        </p>
                      </div>
                    </div>
                  </div>
