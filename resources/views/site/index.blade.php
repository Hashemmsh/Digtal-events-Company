...
<main>
    ...
    <section class="video-banner hero-opacity-20">
        ...
        @if (app()->currentLocale() == 'en')
            <div class="content">
                <img src="{{ asset('siteassets/images/slog-ar.png') }}" alt="" />
            </div>
        @endif
        <video class="fullsize" loop="true" autoplay="autoplay" muted="" playsinline="">
            <source
                ...
                type="video/mp4" poster="https://www.aokevents.com/wp-content/uploads/2022/05/Homepage.png" />
            Your browser does not support the video tag.
        </video>
    </section>


    <div class="partnars mb-5" data-aos="fade-right">
                        ...
                        <div class="row justify-content-center">
                            <div class="Ahdath-details-details" data-aos="fade-left">
                                ...
                                <a href="{{ route('site.about') }}"
                                    class="btn btn-success rounded-pill px-5 mt-3">{{ __('site.see more') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="content fade">
                                            <div class="row justify-content-center">
                                                ...
                                                <a href="{{ route('site.service') }}"
                                                    class="btn btn-succes rounded-pill px-5 mt-3">{{ __('site.see more') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li>{{ $product->trans_title }}</li> --}}
                                ...
                                <div class="btns">
                                    <a href="{{ route('site.product') }}"
                                        class="btn btn-products1 rounded-pill px-5 mt-3">{{ __('site.see more') }}</a>
                                    <a href="{{ route('site.booking') }}"
                                        class="btn btn-products2 rounded-pill px-5 mt-3">
                                        {{ __('site.Booking') }}</a>
                                </div>
                            </div>
                        </div>
    ...
    <div id="numbers" class="numbers mb-4" data-aos="fade-right">
        <div class="container">
            <p class="mb-4">{{ __('site.Numbers we achieved') }}</p>
    ...
    @if (app()->currentLocale() == 'ar')
        <div class="how-do-it" data-aos="fade-left">
            <div class="container">
                ...
                <img src="{{ asset('siteassets/images/-ديسكتوب كيف نقوم بذلك؟.png') }}"
                    class="w-100 d-none d-lg-block" alt="" />
                <img src="{{ asset('siteassets/images/كيف نقوم بذلك ايباد.png') }}"
                    class="w-100 d-none d-md-block d-lg-none" alt="" />
                <img src="{{ asset('siteassets/images/كيف نقوم بذلك موبايل.png') }}" class="w-100 d-md-none"
                    alt="" />
            </div>
        </div>
    @endif
    ...
    @if (app()->currentLocale() == 'en')
        <div class="how-do-it" data-aos="fade-left">
            <div class="container">
                <h3>{{ __('site.How do we do it?') }}</h3>
                <img src="{{ asset('siteassets/images/Group 138.png') }}" class="w-100 d-none d-lg-block"
                    alt="" />
                <img src="{{ asset('siteassets/images/Group 140.png') }}" class="w-100 d-none d-md-block d-lg-none"
                    alt="" />
    ...
    <div class="reviews" data-aos="fade-up">
        <h3>{{ __('site.Success Partners') }}</h3>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="content-reviews">
                            <p class="mx-3">شكرا لكم وبيض الله وجهكم مثل ما بيضتو وجهي</p>
                            <h5>خالد العدواني </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="content-reviews">
                            <p class="mx-3">الافتتاح كان روعه خدمات رائعة</p>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <form action="{{ route('site.reservation') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <input type="text" class="form-control" placeholder="{{ __('site.Name') }}" />
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control" placeholder="{{ __('site.E-mail') }}" />
                            </div>
                            <div class="mb-4">
                    ...
                    <div class="col-lg-5 mx-lg-5">
                        ...
                        <div class="d-flex align-items-left mb-5">
                            ...
                            <div class="contact-details mx-3">
                                ...
                                <p class="mt-1">
                                    المملكة العربية السعودية – جدة شارع حديقة رامي – حي
                                    السلامة
                                </p>
                            </div>
                        </div>
