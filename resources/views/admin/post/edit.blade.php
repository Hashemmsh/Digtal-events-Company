        ...
        <div class="row">
            <div class="col-md-6">
                <div  class="mb-3">
                    ...
                    <input value="{{$post->name_en }}" type="text" name="name_en" placeholder="{{ __('site.English Name') }}" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div  class="mb-3">
                        <label>{{ __('site.Arabic Name') }}</label>
                        <input value="{{ $post->name_ar }}" id="name" type="text" name="name_ar" placeholder="{{ __('site.Arabic Name') }}"
                        class="form-control">
        ...
        <div class="row">
            <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="description_en" placeholder="{{ __('site.English Description') }}" class="form_control customarea" >{{ $post->description_en }}</textarea>
                    </div>
            </div>
            <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        class="form_control customarea" >{{ $post->description_ar }}</textarea>
            ...
            <div class="col-md-12">
                <div  class="mb-5">
                    <div class="input_container">
                        ...
                        <td> <img src="{{ asset('uploads/post/'.$post->image) }}" width="100px" height="100px" alt=""></td>
