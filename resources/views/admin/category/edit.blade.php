        ...
        <div class="row">
            <div class="col-md-6">
                <div  class="mb-3">
                    ...
                    <input value="{{ $category->name_en }}" type="text" name="name_en" placeholder="{{ __('site.English Name') }}" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div  class="mb-3">
                        <label>{{ __('site.Arabic Name') }}</label>
                        <input value="{{ $category->name_ar }}" id="name" type="text" name="name_ar" placeholder="{{ __('site.Arabic Name') }}"
                        class="form-control">
